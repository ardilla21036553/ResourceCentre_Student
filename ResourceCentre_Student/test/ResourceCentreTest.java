...
>>>>>>> branch 'master' of https://github.com/ardilla21036553/ResourceCentre_Student.git
	...
	public void testRetrieveAllChromebook() {
		...
		// Test if Item list is not null but empty, so that can add a new item
<<<<<<< HEAD
		assertNotNull("Test if there is valid Chromebook arraylist to retrive items from", chromebookList);
...
<<<<<<< HEAD
		...
		assertTrue("Test if loaned out chormebook CB0012 is returned- true", isReturned);
